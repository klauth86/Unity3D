...
public class ScoreMasterTest {
    ...
    public void T01Bowl23() {
        int[] rolls = { 2, 3 };
        int[] frames = { 5 };
        Assert.AreEqual(frames.ToList(), ScoreMaster.GetListOfFrameScores(rolls.ToList()));
    }
    ...
    public void T16TestGutterGame() {
        ...
        Assert.AreEqual(totalS.ToList(), ScoreMaster.GetCumulativeListOfFrameScores(rolls.ToList()));
    }
